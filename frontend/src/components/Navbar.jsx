    ...
    <>
        <div className='bg-gray-600'>
          <nav className='flex justify-between items-center p-2 px-5'>
            ...
            <div>
              <form method="post">
                <input className='p-1 rounded-l-md focus:outline-none' type="text" placeholder='Search for Companies' />
                <button className='text-black bg-yellow-500 border-none p-1 rounded-r-md' type='submit'>Search</button>
              </form>
            </div>
